/**
 * Utility to play a pleasant, crisp notification chime.
 * Uses both Audio element (/notification-chime.wav) and Web Audio API
 * for guaranteed browser compatibility across desktop and mobile.
 */
...
/**
 * Unlocks audio on first user gesture (click, touch, key).
 */
